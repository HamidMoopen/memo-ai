    ...
    <div className="min-h-screen bg-[#faf9f6] text-[#383f51]">
      <header className="fixed top-0 left-0 right-0 bg-white z-10 shadow-sm">
        <div className="container mx-auto px-4 sm:px-8 py-4 sm:py-6 flex items-center justify-between">
          <Link href="/" className="text-2xl sm:text-3xl font-bold text-[#3c4f76]">
            Eterna
          </Link>
          <Link href="/login">
            <Button className="bg-[#3c4f76] hover:bg-[#2a3b5a] text-white text-base sm:text-lg px-4 sm:px-8 py-2 sm:py-6 rounded-xl sm:rounded-2xl">
      ...
      <main className="pt-20 sm:pt-28">
        <section className="container mx-auto px-4 sm:px-8 py-8 sm:py-16">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-8 text-[#3c4f76] leading-tight animate-fade-in">
                Preserve and explore your family's legacy with AI-driven storytelling
              </h1>
              <p className="text-lg sm:text-2xl mb-8 sm:mb-12 text-[#383f51]/90 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="container mx-auto px-4 sm:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-12">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="bg-[#faf9f6] p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow hover:shadow-lg transition-all duration-300"
                >
                  <div className="w-16 sm:w-20 h-16 sm:h-20 bg-[#3c4f76]/10 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6">
                    <feature.icon className="w-8 sm:w-10 h-8 sm:h-10 text-[#3c4f76]" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 text-[#3c4f76]">{feature.title}</h3>
                  <p className="text-base sm:text-lg text-[#383f51]">{feature.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 sm:py-24 bg-gradient-to-b from-white to-[#faf9f6]">
          <div className="container mx-auto px-4 sm:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <blockquote className="text-xl sm:text-3xl italic mb-8 sm:mb-12 text-[#3c4f76] leading-relaxed">
      ...
      <footer className="bg-white py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#3c4f76] mb-4 sm:mb-6">
            Start preserving your family's legacy today
          </h2>
          <p className="text-lg sm:text-xl text-[#383f51] mb-6 sm:mb-8 max-w-2xl mx-auto">
            Join thousands of families to capture and preserve precious memories
          </p>
          <Link href="/login">
            <Button className="bg-[#3c4f76] hover:bg-[#2a3b5a] text-white text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-6 rounded-xl sm:rounded-2xl">
              Try it out now
            </Button>
          </Link>
        </div>
